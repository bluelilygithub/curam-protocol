"""
Department configuration for sample files, descriptions, and field schemas.
Contains all the static configuration data for the automater application.
"""

# Default department selection
DEFAULT_DEPARTMENT = "finance"

# Department sample files configuration
DEPARTMENT_SAMPLES = {
    "finance": {
        ...
        "samples": [
            ...
            {"path": "invoices/John Deere Construction & Forestry Commercial Invoice.pdf", 
             "label": "John Deere Construction & Forestry Commercial Invoice.pdf"},
            {"path": "invoices/Lenovo Global Logistics Commercial Invoice.pdf", 
             "label": "Lenovo Global Logistics Commercial Invoice.pdf"},
            {"path": "invoices/Shenzhen Fast-Circuit Co Commercial Invoice.pdf", 
             "label": "Shenzhen Fast-Circuit Co Commercial Invoice.pdf"}
        ]
    },
    "engineering": {
        ...
        "samples": [
            ...
            {"path": "drawings/column_complex_messy.pdf", "label": "column_schedule_MESSY.pdf"}
        ]
    },
    "transmittal": {
...
# Reverse mapping: sample path to department
SAMPLE_TO_DEPT = {
...
# Allowed sample paths for security validation
...
# Routine descriptions shown in the UI
...
# Routine summary for quick reference
ROUTINE_SUMMARY = {
    "finance": [
...
FINANCE_FIELDS = [
    "Vendor", "Date", "InvoiceNum", "Cost", "GST", "FinalAmount", 
    "Summary", "LineItems", "ShippingTerms", "HSCodes", "Currency", 
    "ABN", "POReference", "PaymentTerms", "DueDate", "PortOfLoading", 
    "PortOfDischarge", "VesselVoyage", "BillOfLading", "Flags"
]

ENGINEERING_BEAM_FIELDS = [
    "Mark", "Size", "Qty", "Length", "Grade", "PaintSystem", "Comments"
]

ENGINEERING_COLUMN_FIELDS = [
    "Mark", "SectionType", "Size", "Length", "Grade", 
    "BasePlate", "CapPlate", "Finish", "Comments"
]

TRANSMITTAL_FIELDS = [
    "DwgNo", "Rev", "Title", "Scale"
]

# Document type to fields mapping
DOC_FIELDS = {
    "finance": FINANCE_FIELDS,
    "engineering": ENGINEERING_BEAM_FIELDS,  # Default, overridden based on detected type
    "transmittal": TRANSMITTAL_FIELDS
}

# Error field mapping (which field to show errors in)
ERROR_FIELD = {
    "finance": "Summary",
