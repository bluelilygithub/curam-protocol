...
**SEO** (`/seo`): Simple on-page audit from a URL (titles, headings, robots, HTTPS, alt text). HTML scrape only — no Ads keywords. Table: `seo_audits`. Feature flag `seo`. Docs: **`docs/seo-agent.md`**.
