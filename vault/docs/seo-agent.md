...
5. **Use** — copy or download. Keyword lists use Google Ads syntax (`"phrase"`, `[exact]`, broad unquoted) one per line so they paste into Ads. Headlines and descriptions are plain lines or CSV.
