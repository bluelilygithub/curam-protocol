...
- Five progress tiles: BDI-style mood check, IPIP-NEO-120 personality inventory, HEXACO-60-style personality check, CERQ-style cognitive coping check, and Brief COPE-style coping check.
- A progress indicator showing which of the five tests have been completed.
- Consistent **Review or retake** actions on completed test tiles.
- A subtly highlighted results area that unlocks the combined profile, charts, mind map, and personal development suggestions only after all five tests are completed.
...
The Combined Profile is locked until the user has completed all five tests at least once.

When generated, it uses the latest completed result from each test. Users can choose one of three report levels:

- **Summary**: a concise overview of the five tests for either client or clinician orientation.
...
- **Suggestions**: a client-readable personal development report that turns the five-test pattern into reflective strengths, coping, communication, and small-experiment suggestions without presenting them as diagnosis or treatment advice.
...
The visual summary unlocks after all five tests are completed.
...
- Mind map connecting related themes across the five tests.
...
All five tests support pause/resume and back navigation.
