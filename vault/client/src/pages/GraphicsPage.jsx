          ...
          {graphicsInfo.show && (
            <ToolInfoModal title="How Graphics Works" onClose={graphicsInfo.close}>
              ...
              <div className="rounded-lg p-3 text-sm space-y-2" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
                ...
                <p style={{ color: 'var(--color-text)' }}><strong>Augment</strong> — the "Variation" step under a generated result — is real image-to-image, not a re-roll: your current image feeds back in as the starting point with a new prompt and a denoise-strength dial for how much changes. This is how you refine or riff on something you already have, without starting over from a blank prompt.</p>
