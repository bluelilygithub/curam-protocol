...
// Client management (create/edit/deactivate/delete) moved fully to the CRM
// module (server/routes/clients.js) — this route is now picker-only, used
// by the invoice/quote client dropdown. See docs/crm-migration.md.
